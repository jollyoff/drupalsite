...
jQuery(document).ready(function ($) {
  var slideCount = $('.main-slider .slider').length;
  var slideWidth = $('.main-slider .slider').width();
  var slideHeight = $('.main-slider .slider').height();
  var sliderUlWidth = slideCount * slideWidth;

  $('.item-main-list').css({ width: slideWidth, height: slideHeight });

  $('.main-slider').css({ width: sliderUlWidth, marginLeft: -slideWidth });

  $('.main-slider .slider:last-child').prependTo('.main-slider');
  ...
  function moveRight() {
    $('.main-slider').animate({
      ...
      $('.main-slider .slider:first-child').appendTo('.main-slider');
      $('.main-slider').css('left', '');
    });
  }
  ...
  $('.item-main-list').append('<a class="control_prev" href="#">Назад</a><a class="control_next" href="#">Вперед</a>');
