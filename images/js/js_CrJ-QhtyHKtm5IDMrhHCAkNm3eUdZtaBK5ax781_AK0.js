...
jQuery(document).ready(function ($) {
  ...
  var itemMainList = $('.item-main-list ul');
  var slides = itemMainList.find('li');
  ...
  itemMainList.css({ width: sliderUlWidth, marginLeft: -slideWidth });

  slides.last().prependTo('.item-main-list ul');

  function moveLeft() {
    itemMainList.animate({
      left: +slideWidth
    }, 200, function () {
      slides.last().prependTo('.item-main-list ul');
      itemMainList.css('left', '');
    });
  }
  ...
  function moveRight() {
    itemMainList.animate({
      ...
      slides.first().appendTo('.item-main-list ul');
      itemMainList.css('left', '');
    });
  }
