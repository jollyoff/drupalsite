...
jQuery(document).ready(function ($) {
  ...
  var slideCount = $('.item-main-list ul li').length;
  var slideWidth = $('.item-main-list ul li').width();
  var slideHeight = $('.item-main-list ul li').height();
  var sliderUlWidth = slideCount * slideWidth;

  $('.item-main-list').css({ width: slideWidth, height: slideHeight });

  $('.item-main-list ul').css({ width: sliderUlWidth, marginLeft: - slideWidth });

  $('.item-main-list ul li:last-child').prependTo('#slider ul');

  function moveLeft() {
    $('.item-main-list ul').animate({
      left: + slideWidth
    }, 200, function () {
      $('.item-main-list ul li:last-child').prependTo('#slider ul');
      $('.item-main-list ul').css('left', '');
    });
  };
  ...
  function moveRight() {
    $('.item-main-list ul').animate({
      ...
      $('.item-main-list ul li:first-child').appendTo('#slider ul');
      $('.item-main-list ul').css('left', '');
    });
  };
