...
document.addEventListener('DOMContentLoaded', function () {
  console.log('working');
  const nextBtn = document.querySelector('.item-main-list .buttons .control_next');
  const prevBtn = document.querySelector('.item-main-list .buttons .control_prev');
  const slider = document.querySelector('.item-main-list .main-slider');
  const slides = document.querySelectorAll('.item-main-list .main-slider .slider');
  let currentIndex = 0;
